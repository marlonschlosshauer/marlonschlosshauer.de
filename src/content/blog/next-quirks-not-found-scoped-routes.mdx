...
import { Quirks } from "@/components/blog/quirks/Quirks";
...
<Note.Frame variant="secondary">
    <Note.Header>
        <Note.Headline>Update</Note.Headline>
    </Note.Header>
    <Note.Body>
        The Next.js team added an experimental feature called
        [root-params](https://nextjs.org/docs/app/api-reference/functions/next-root-params) which
        makes this a non-issue! [Here is an article by Aurora
        Scharff](https://aurorascharff.no/posts/implementing-nextjs-16-use-cache-with-next-intl-internationalization/#update-nextroot-params-is-here-nextjs-162)
        showing how use this new feature.
    </Note.Body>
</Note.Frame>
