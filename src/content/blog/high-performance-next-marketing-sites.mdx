...
Like many things I will be mentioning here today, [PPR](https://nextjs.org/docs/app/guides/prefetching#partial-prerendering-ppr) will alleviate some of the pain here, so look towards upgrading if your site relies on dynamic data.
