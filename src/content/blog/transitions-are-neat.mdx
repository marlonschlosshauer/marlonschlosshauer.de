...
export const metadata = {
    title: "Implicitly capturing pending states with React transitions",
    description: "Exploring async composition on the client with React Transitions.",
    date: "2025-10-04",
    words: 1800,
    tags: ["next.js", "react", "concurrency-api"],
    favorite: true,
};

# Implicitly capturing pending states with React transitions
