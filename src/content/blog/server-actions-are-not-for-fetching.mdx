...
<div className="mb-8">
    <Note.Frame variant="secondary">
        ...
        <Note.Body>
            ...
            which can be used to query data. This is especially cool because it lets [you grab RSC
            from the
            client](https://tanstack.com/blog/react-server-components#what-do-they-look-like)
