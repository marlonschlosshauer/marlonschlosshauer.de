...
<Note.Frame variant="ghost">
    <Note.Header>
        <Note.Headline>Note</Note.Headline>
    </Note.Header>
    <Note.Body>
        It is important to note that [the nesting of Cache
        Components](https://nextjs.org/docs/app/api-reference/functions/cacheLife#nested-caching-behavior)
